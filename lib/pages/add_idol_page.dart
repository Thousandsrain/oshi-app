...
class AddIdolPage extends StatefulWidget {
  const AddIdolPage({super.key});

  @override
  State<AddIdolPage> createState() => _AddIdolPageState();
}

class _AddIdolPageState extends State<AddIdolPage> {
  ...
  Future<void> _save() async {
    ...
    for (final groupId in _selectedGroupIds) {
      await db.insert('idol_groups', {'idol_id': idolId, 'group_id': groupId});
    }
            ...
            child: TextFormField(
              ...
              validator: required
                  ? (v) => v == null || v.trim().isEmpty
                        ? AppText(appLanguageController.language).inputRequired(label)
                        : null
                  : null,
            ),
          ),
